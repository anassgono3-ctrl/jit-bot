...
const REQUIRED_VICTIM_TX_FIELDS = ['hash', 'rawTx', 'data', 'from', 'to'];

const REQUIRED_SWAP_PARAMS = ['tokenIn', 'tokenOut', 'amountIn', 'fee'];
...
function validateFixture(fixturePath) {
  ...
  try {
    ...
    if (!fixture.victimTransaction.hash.match(/^0x[a-fA-F0-9]{64}$/)) {
      throw new Error(
        `Invalid transaction hash: ${fixture.victimTransaction.hash}`
      );
    }
  ...
  if (!fs.existsSync(reportsDir)) {
    ...
    const exampleFixture = {
      ...
      victimTransaction: {
        ...
        rawTx:
          '0x02f86d0182f618843b9aca0085012a05f200825208948ad599c3a0ff1de082011efddc58f1908eb6e6d8872386f26fc10000880de0b6b3a764000080c0',
