...
async function main() {
  ...
  console.log(
    ...
    ethers.utils.formatEther(minProfitThreshold),
    'ETH'
  );
  console.log(
    '   Max loan size:',
    ethers.utils.formatEther(maxLoanSize),
    'ETH'
  );
  ...
  try {
    ...
    console.log(
      '   Min profit threshold:',
      ethers.utils.formatEther(deployedMinProfit),
      'ETH'
    );
    console.log(
      '   Max loan size:',
      ethers.utils.formatEther(deployedMaxLoan),
      'ETH'
    );
    ...
    if (networkName === 'fork') {
      ...
      console.log(
        '🔥 This contract will interact with real funds on Ethereum mainnet'
      );
      console.log(
        '🛡️ Make sure you understand the risks and have tested thoroughly'
      );
    } else {
